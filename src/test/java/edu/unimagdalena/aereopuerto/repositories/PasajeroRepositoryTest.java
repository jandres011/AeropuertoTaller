...
class PasajeroRepositoryTest {
    ...
    void setUp() {
        ...
        vueloRepository.save(vuelo2 = Vuelo.builder().origen("Santa Marta").destino("Medellín").build());
    ...
    void findPasajerosByNombreLike() {
        List<Pasajero> pasajerosTest = pasajeroRepository.findPasajerosByNombreLike("%Juan%");
        Assertions.assertFalse(pasajerosTest.isEmpty());
        Assertions.assertEquals(3, pasajerosTest.size());
    }
