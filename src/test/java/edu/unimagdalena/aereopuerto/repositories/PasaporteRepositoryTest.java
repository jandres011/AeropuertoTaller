...
class PasaporteRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        pasajero1 = Pasajero.builder().NID("25A").nombre("Juan Antonio").build();
        pasajero2 = Pasajero.builder().NID("21B").nombre("Juan Andrés").build();
        pasajero3 = Pasajero.builder().NID("25C").nombre("Andrés Juan").build();
    ...
    void findPasaporteByNumero() {
        Pasaporte pasaporteTest = pasaporteRepository.findPasaporteByNumero("A578B");
        Assertions.assertNotNull(pasaporteTest);
        Assertions.assertEquals("A578B", pasaporteTest.getNumero());
    }
    ...
    void findPasaportesByNumeroContaining() {
        List<Pasaporte> pasaporteTest = pasaporteRepository.findPasaportesByNumeroContaining("A5");
        Assertions.assertNotNull(pasaporteTest);
    ...
    void findPasaportesByNumeroStartingWith() {
        List<Pasaporte> pasaportesTest = pasaporteRepository.findPasaportesByNumeroStartingWith("A5");
        Assertions.assertFalse(pasaportesTest.isEmpty());
